            ...
            <div class="row">
                ...
                <div class="col-md">
                    <div class="card">
						...
						<form action="manage-startup.php" method="post">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
								...
								<?php foreach($people as $person): ?>
									...
									<td>
              <a href="edit-startup.php?startupID=<?= $person->startupID ?>" class="btn btn-info">Edit</a>
              <a onclick="return confirm('Are you sure you want to delete this entry?')" href="delete-startup.php?startupID=<?= $person->startupID ?>" class='btn btn-danger'>Delete</a>
                                    </td>
                                    </tr>
								 <?php endforeach; ?>
                                    </tbody>
