...
$sql = 'INSERT INTO startup(name,address,email,contact,startDate,staff,category) VALUES(:name, :address, :email, :contact, :startDate, :staff, :category)';
$statement = $connection->prepare($sql);



if($statement->execute([':name' => $name,':address' => $address, ':email'=>$email, ':contact' => $contact, ':startDate' => $startDate, ':staff'=>$staff, ':category' => $category,])){
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
							...
							<?php endif; ?>
							   ...
							   <button type="submit" class="btn btn-info">Create Startup</button>
							   </div>
							   </form>
                            </div>
                        </div>
